...
const Terms = () => {
  return (
    <div style={{ padding: "20px" }}>
      ...
      <p>
        You agree to not use the service for any unlawful purposes or in any way
        that might harm, abuse, or otherwise interfere with the service or other
        users.
      </p>
      <h2>4. Intellectual Property</h2>
      <p>
        All content included on this site, such as text, graphics, logos,
        images, and software, is the property of E-Mall World or its content
        suppliers and protected by international copyright laws.
      </p>
      <h2>5. Limitation of Liability</h2>
      <p>
        E-Mall World shall not be liable for any direct, indirect, incidental,
      ...
      <p>
        ...
        of the jurisdiction where E-Mall World is located, without regard to its
